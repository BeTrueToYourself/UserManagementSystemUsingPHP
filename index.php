...
<div class="content">
    ...
    <div class="row">
      <div class="col-4 offset-md-4" style="margin-top: 30px;">
		...
		<br>
    <tr> 
			  <td><center><b><em><?php echo "Dear ".$_SESSION['username'].","; ?></em> </b></center></td>
			  </tr>

    <tr> 
			  <td><center><b><?php echo "You can post a story here....!!!!" ?> </b></center></td>
			  </tr>
        <br>
  ...
  <tr> 
    ...
    <tr> 
			  <td><center><b><?php echo "You can add a quote here....!!!!" ?> </b></center></td>
			  </tr>
        <br>
  <a href="addquote.php" class="btn btn-success"><b>Add A Quote</b></a>
		<br>
    <br>
    ...
    <tr> 
			  <td><center><b><?php echo "You can view your quotes here....!!!!" ?> </b></center></td>
			  </tr>
        <br>
    <a href="Viewquote.php" class="btn btn-success"><b>View Quotes</b></a>
		<br>
    <br>
    <br>
    <br>

    	<p> <a href="index.php?logout='1'" style="color: white;background-color:#F50324;" class="btn btn-danger"><b>Log Out</b></a> </p>
    <?php endif ?>
</div>
